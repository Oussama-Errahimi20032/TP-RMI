...
public class ClientRMI {
    ...
    public static void main(String[] args) {
        try {
            ...
            dao.create(new Machine("Hp", "Hp", 8000,dao2.findById(2)));
            dao.create(new Machine("lenovo", "Lenovo", 7000,dao2.findById(1)));
            dao.create(new Machine("dell", "dell", 6000,dao2.findById(1)));
